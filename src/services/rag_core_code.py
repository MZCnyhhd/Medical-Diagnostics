...
from typing import List                                                 # 类型提示：列表类型注解
# [第三方库 | Third-party Libraries] ====================================================================================
from langchain_pinecone import PineconeVectorStore, PineconeEmbeddings  # Pinecone 云端向量存储
from langchain_community.vectorstores import FAISS                      # FAISS 云端向量存储
# [内部模块 | Internal Modules] =========================================================================================
from src.services.logging import log_warn                               # 统一日志服务：警告级别日志
# [定义函数] ############################################################################################################
# [内部- RAG 是否已启用] ==================================================================================================
...
# [内部-加载本地FAISS索引] ================================================================================================
def _load_local_faiss() -> FAISS | None:
    """
    加载本地 FAISS 向量索引。
    ...
    try:
        ...
        return None
# [内部-加载Pinecone云端索引] =============================================================================================
def _load_pinecone_index() -> PineconeVectorStore | None:
    """
    加载 Pinecone 云端向量索引。
